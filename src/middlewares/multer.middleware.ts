...
// A visual report is a high-resolution PDF capture of the result page and can
// legitimately be larger than a standard document upload.
export const reportPdfUpload = multer({
      storage,
